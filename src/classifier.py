...
LLM_MODEL = os.environ.get("SESHA_CLASSIFIER_MODEL", "phi4-mini")
# Set SESHA_NO_LLM=1 to disable LLM calls (fully offline/deterministic).
NO_LLM = os.environ.get("SESHA_NO_LLM") == "1"
